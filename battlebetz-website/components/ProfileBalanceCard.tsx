      ...
      <View style={styles.balanceCard}>
        ...
        <View style={styles.balanceItems}>
          <View style={styles.balanceItem}>
            ...
            <Text style={styles.balanceValue}>BBZ 2,450</Text>
          </View>
          <View style={styles.balanceItem}>
            <Text style={styles.balanceLabel}>BBZ.T Balance</Text>
            <Text style={[styles.balanceValue, styles.tournamentBalance]}>BBZ.T 1,000</Text>
          </View>
          <View style={styles.balanceItem}>
            <Text style={styles.balanceLabel}>USD Balance</Text>
            <Text style={styles.balanceValue}>USD 150.00</Text>
          </View>
        </View>
        <TouchableOpacity 
