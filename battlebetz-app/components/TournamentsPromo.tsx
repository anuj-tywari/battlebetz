...
import { Trophy, Calendar, DollarSign, Users, Info, LogIn } from 'lucide-react-native';
...
export default function TournamentsPromo() {
  ...
  // Use the tournament data hook to check user's tournament participation
  ...
  useEffect(() => {
    ...
    const fetchAvailableTournaments = async () => {
      ...
      try {
        ...
        // 5. Limit to 4 tournaments maximum
        setAvailableTournaments(sortedTournaments.slice(0, 4));
      } catch (err) {
              ...
              >
                ...
                <View style={styles.cardContent}>
                  ...
                  <View style={styles.detailRow}>
                    <DollarSign size={14} color="#A259FF" />
